...
void deblock_edge_hor_c_sse128(pel_t *SrcPtrU, pel_t *SrcPtrV, int stride, int Alpha, int Beta, uchar_t *flt_flag)
{
    ...
    TL0 = _mm_set_epi32(0, 0, ((i32s_t*)(SrcPtrV - inc))[0], ((i32s_t*)(SrcPtrU - inc))[0]);
    TL1 = _mm_set_epi32(0, 0, ((i32s_t*)(SrcPtrV - inc2))[0], ((i32s_t*)(SrcPtrU - inc2))[0]);
    TL2 = _mm_set_epi32(0, 0, ((i32s_t*)(SrcPtrV - inc3))[0], ((i32s_t*)(SrcPtrU - inc3))[0]);
    TR0 = _mm_set_epi32(0, 0, ((i32s_t*)(SrcPtrV))[0], ((i32s_t*)(SrcPtrU))[0]);
    TR1 = _mm_set_epi32(0, 0, ((i32s_t*)(SrcPtrV + inc))[0], ((i32s_t*)(SrcPtrU + inc))[0]);
    TR2 = _mm_set_epi32(0, 0, ((i32s_t*)(SrcPtrV + inc2))[0], ((i32s_t*)(SrcPtrU + inc2))[0]);
...
#undef _mm_subabs_epu16
    ...
    ((i32s_t*)(SrcPtrU - inc ))[0] = _mm_extract_epi32(UL0, 0);
    ((i32s_t*)(SrcPtrU       ))[0] = _mm_extract_epi32(UR0, 0);
    ((i32s_t*)(SrcPtrU - inc2))[0] = _mm_extract_epi32(UL1, 0);
    ((i32s_t*)(SrcPtrU + inc ))[0] = _mm_extract_epi32(UR1, 0);
    ((i32s_t*)(SrcPtrV - inc ))[0] = _mm_extract_epi32(UL0, 1);
    ((i32s_t*)(SrcPtrV       ))[0] = _mm_extract_epi32(UR0, 1);
    ((i32s_t*)(SrcPtrV - inc2))[0] = _mm_extract_epi32(UL1, 1);
    ((i32s_t*)(SrcPtrV + inc ))[0] = _mm_extract_epi32(UR1, 1);
}
...
#undef _mm_subabs_epu16
	...
	((i64s_t*)(SrcPtrU - inc ))[0] = _mm_extract_epi64(UL0, 0);
	((i64s_t*)(SrcPtrU       ))[0] = _mm_extract_epi64(UR0, 0);
	((i64s_t*)(SrcPtrU - inc2))[0] = _mm_extract_epi64(UL1, 0);
	((i64s_t*)(SrcPtrU +  inc))[0] = _mm_extract_epi64(UR1, 0);
	((i64s_t*)(SrcPtrV -  inc))[0] = _mm_extract_epi64(UL0, 1);
	((i64s_t*)(SrcPtrV       ))[0] = _mm_extract_epi64(UR0, 1);
	((i64s_t*)(SrcPtrV - inc2))[0] = _mm_extract_epi64(UL1, 1);
	((i64s_t*)(SrcPtrV +  inc))[0] = _mm_extract_epi64(UR1, 1);
}
