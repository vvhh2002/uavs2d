...
void deblock_edge_hor_sse256(pel_t *SrcPtr, int stride, int Alpha, int Beta, uchar_t *flt_flag)
{
    ...
    __m128i ALPHA = _mm_set1_epi16(Alpha);
    __m128i BETA = _mm_set1_epi16(Beta);
    ...
    __m256i BETA_256 = _mm256_set1_epi16(Beta);
...
void deblock_edge_hor_c_sse256(pel_t *SrcPtrU, pel_t *SrcPtrV, int stride, int Alpha, int Beta, uchar_t *flt_flag)
{
	...
	TLR0 = _mm256_set_epi32(0, 0, ((i32s_t*)(SrcPtrV))[0], ((i32s_t*)(SrcPtrU))[0], 0, 0, ((i32s_t*)(SrcPtrV - inc))[0], ((i32s_t*)(SrcPtrU - inc))[0]);
	TLR1 = _mm256_set_epi32(0, 0, ((i32s_t*)(SrcPtrV + inc))[0], ((i32s_t*)(SrcPtrU + inc))[0], 0, 0, ((i32s_t*)(SrcPtrV - inc2))[0], ((i32s_t*)(SrcPtrU - inc2))[0]);
	TLR2 = _mm256_set_epi32(0, 0, ((i32s_t*)(SrcPtrV + inc2))[0], ((i32s_t*)(SrcPtrU + inc2))[0], 0, 0, ((i32s_t*)(SrcPtrV - inc3))[0], ((i32s_t*)(SrcPtrU - inc3))[0]);
	...
	((i32s_t*)(SrcPtrU - inc ))[0] = _mm256_extract_epi32(TLR0w, 0);
	((i32s_t*)(SrcPtrU       ))[0] = _mm256_extract_epi32(TLR0w, 4);
	((i32s_t*)(SrcPtrU - inc2))[0] = _mm256_extract_epi32(TLR1w, 0);
	((i32s_t*)(SrcPtrU + inc ))[0] = _mm256_extract_epi32(TLR1w, 4);
	((i32s_t*)(SrcPtrV - inc ))[0] = _mm256_extract_epi32(TLR0w, 1);
	((i32s_t*)(SrcPtrV       ))[0] = _mm256_extract_epi32(TLR0w, 5);
	((i32s_t*)(SrcPtrV - inc2))[0] = _mm256_extract_epi32(TLR1w, 1);
	((i32s_t*)(SrcPtrV + inc ))[0] = _mm256_extract_epi32(TLR1w, 5);
