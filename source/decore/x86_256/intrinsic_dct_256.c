...
ALIGNED_32(static const coef_t tab_idct_8x8_256[12][16]) =
{
...
{
	__m256i m256iAdd;
	__m256i m256iS1S5, m256iS3S7;
	__m256i m256Tmp0, m256Tmp1, m256Tmp2, m256Tmp3;
	__m256i E0, E1, E2, E3, O0, O1, O2, O3;
	__m256i EE0, EE1, EO0, EO1;
	__m256i m256iS0, m256iS1, m256iS2, m256iS3, m256iS4, m256iS5, m256iS6, m256iS7;
	__m256i C00, C01, C02, C03, C04, C05, C06, C07;
	__m256i max_val, min_val;


	m256iS1S5 = _mm256_loadu2_m128i((__m128i*)&blk[40], (__m128i*)&blk[8]);
	m256iS3S7 = _mm256_loadu2_m128i((__m128i*)&blk[56], (__m128i*)&blk[24]);

	m256Tmp0 = _mm256_unpacklo_epi16(m256iS1S5, m256iS3S7);
	m256Tmp1 = _mm256_unpackhi_epi16(m256iS1S5, m256iS3S7);

	m256Tmp2 = _mm256_permute2x128_si256(m256Tmp0, m256Tmp1, 0x20);
	m256Tmp3 = _mm256_permute2x128_si256(m256Tmp0, m256Tmp1, 0x31);

	E1 = _mm256_madd_epi16(m256Tmp2, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[0])));
	E2 = _mm256_madd_epi16(m256Tmp3, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[1])));
	O0 = _mm256_add_epi32(E1, E2);

	E1 = _mm256_madd_epi16(m256Tmp2, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[2])));
	E2 = _mm256_madd_epi16(m256Tmp3, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[3])));
	O1 = _mm256_add_epi32(E1, E2);

	E1 = _mm256_madd_epi16(m256Tmp2, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[4])));
	E2 = _mm256_madd_epi16(m256Tmp3, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[5])));
	O2 = _mm256_add_epi32(E1, E2);

	E1 = _mm256_madd_epi16(m256Tmp2, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[6])));
	E2 = _mm256_madd_epi16(m256Tmp3, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[7])));
	O3 = _mm256_add_epi32(E1, E2);


	/*    -------     */


	m256iS1S5 = _mm256_loadu2_m128i((__m128i*)&blk[16], (__m128i*)&blk[0]);
	m256iS3S7 = _mm256_loadu2_m128i((__m128i*)&blk[48], (__m128i*)&blk[32]);
	...
	EE0 = _mm256_madd_epi16(m256Tmp2, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[8])));
	EE1 = _mm256_madd_epi16(m256Tmp2, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[9])));
	EO0 = _mm256_madd_epi16(m256Tmp3, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[10])));
	EO1 = _mm256_madd_epi16(m256Tmp3, _mm256_lddqu_si256((__m256i*)(tab_idct_8x8_256[11])));

	/*    -------     */


	m256iAdd = _mm256_set1_epi32(16);								// 首次反变换四舍五入的数字

	E0 = _mm256_add_epi32(EE0, EO0);
	E1 = _mm256_add_epi32(EE1, EO1);
	E3 = _mm256_sub_epi32(EE0, EO0);
	E2 = _mm256_sub_epi32(EE1, EO1);
	E0 = _mm256_add_epi32(E0, m256iAdd);
	E1 = _mm256_add_epi32(E1, m256iAdd);
	E2 = _mm256_add_epi32(E2, m256iAdd);
	E3 = _mm256_add_epi32(E3, m256iAdd);

	m256iS0 = _mm256_srai_epi32(_mm256_add_epi32(E0, O0), 5);
	m256iS7 = _mm256_srai_epi32(_mm256_sub_epi32(E0, O0), 5);
	m256iS1 = _mm256_srai_epi32(_mm256_add_epi32(E1, O1), 5);
	m256iS6 = _mm256_srai_epi32(_mm256_sub_epi32(E1, O1), 5);
	m256iS2 = _mm256_srai_epi32(_mm256_add_epi32(E2, O2), 5);
	m256iS5 = _mm256_srai_epi32(_mm256_sub_epi32(E2, O2), 5);
	m256iS3 = _mm256_srai_epi32(_mm256_add_epi32(E3, O3), 5);
	m256iS4 = _mm256_srai_epi32(_mm256_sub_epi32(E3, O3), 5);

	C00 = _mm256_permute2x128_si256(m256iS0, m256iS4, 0x20);
	C01 = _mm256_permute2x128_si256(m256iS0, m256iS4, 0x31);

	C02 = _mm256_permute2x128_si256(m256iS1, m256iS5, 0x20);
	C03 = _mm256_permute2x128_si256(m256iS1, m256iS5, 0x31);

	C04 = _mm256_permute2x128_si256(m256iS2, m256iS6, 0x20);
	C05 = _mm256_permute2x128_si256(m256iS2, m256iS6, 0x31);

	C06 = _mm256_permute2x128_si256(m256iS3, m256iS7, 0x20);
	C07 = _mm256_permute2x128_si256(m256iS3, m256iS7, 0x31);

	m256iS0 = _mm256_packs_epi32(C00, C01);
	m256iS1 = _mm256_packs_epi32(C02, C03);
	m256iS2 = _mm256_packs_epi32(C04, C05);
	m256iS3 = _mm256_packs_epi32(C06, C07);

	m256iS4 = _mm256_unpacklo_epi16(m256iS0, m256iS1);
	m256iS5 = _mm256_unpacklo_epi16(m256iS2, m256iS3);
	m256iS6 = _mm256_unpackhi_epi16(m256iS0, m256iS1);
	m256iS7 = _mm256_unpackhi_epi16(m256iS2, m256iS3);

	C00 = _mm256_unpacklo_epi32(m256iS4, m256iS5);
	C01 = _mm256_unpacklo_epi32(m256iS6, m256iS7);
	C02 = _mm256_unpackhi_epi32(m256iS4, m256iS5);
	C03 = _mm256_unpackhi_epi32(m256iS6, m256iS7);
	...
	m256iS0 = _mm256_unpacklo_epi64(C04, C05);
	m256iS1 = _mm256_unpacklo_epi64(C06, C07);

	m256iS2 = _mm256_unpackhi_epi64(C04, C05);
	m256iS3 = _mm256_unpackhi_epi64(C06, C07);

	m256iS4 = _mm256_permute2x128_si256(m256iS2, m256iS3, 0x20);
	m256iS5 = _mm256_permute2x128_si256(m256iS2, m256iS3, 0x31);


	m256Tmp0 = _mm256_unpacklo_epi16(m256iS4, m256iS5);
	m256Tmp1 = _mm256_unpackhi_epi16(m256iS4, m256iS5);
	...
	m256Tmp0 = _mm256_unpacklo_epi16(m256iS0, m256iS1);
	m256Tmp1 = _mm256_unpackhi_epi16(m256iS0, m256iS1);
	...
	m256iAdd = _mm256_set1_epi32(shift ? (1 << (shift - 1)) : 0);							//设置四舍五入
	...
	m256iS0 = _mm256_srai_epi32(_mm256_add_epi32(E0, O0), shift);
	m256iS7 = _mm256_srai_epi32(_mm256_sub_epi32(E0, O0), shift);
	m256iS1 = _mm256_srai_epi32(_mm256_add_epi32(E1, O1), shift);
	m256iS6 = _mm256_srai_epi32(_mm256_sub_epi32(E1, O1), shift);
	m256iS2 = _mm256_srai_epi32(_mm256_add_epi32(E2, O2), shift);
	m256iS5 = _mm256_srai_epi32(_mm256_sub_epi32(E2, O2), shift);
	m256iS3 = _mm256_srai_epi32(_mm256_add_epi32(E3, O3), shift);
	m256iS4 = _mm256_srai_epi32(_mm256_sub_epi32(E3, O3), shift);
	...
	m256iS0 = _mm256_min_epi16(m256iS0, max_val);
	m256iS0 = _mm256_max_epi16(m256iS0, min_val);
	m256iS1 = _mm256_min_epi16(m256iS1, max_val);
	m256iS1 = _mm256_max_epi16(m256iS1, min_val);
	m256iS2 = _mm256_min_epi16(m256iS2, max_val);
	m256iS2 = _mm256_max_epi16(m256iS2, min_val);
	m256iS3 = _mm256_min_epi16(m256iS3, max_val);
	m256iS3 = _mm256_max_epi16(m256iS3, min_val);

	_mm256_storeu2_m128i((__m128i*)&blk[16], (__m128i*)&blk[0], m256iS0);
	_mm256_storeu2_m128i((__m128i*)&blk[48], (__m128i*)&blk[32], m256iS1);
	_mm256_storeu2_m128i((__m128i*)&blk[24], (__m128i*)&blk[8], m256iS2);
	_mm256_storeu2_m128i((__m128i*)&blk[56], (__m128i*)&blk[40], m256iS3);
}
...
void idct_16x16_sse256(coef_t *blk, int shift, int clip)
{
	...
	in00 = _mm256_lddqu_si256((const __m256i*)&blk[0 * 16]);	// [07 06 05 04 03 02 01 00]
	in01 = _mm256_lddqu_si256((const __m256i*)&blk[1 * 16]);  // [17 16 15 14 13 12 11 10]
	in02 = _mm256_lddqu_si256((const __m256i*)&blk[2 * 16]); // [27 26 25 24 23 22 21 20]
	in03 = _mm256_lddqu_si256((const __m256i*)&blk[3 * 16]);     // [37 36 35 34 33 32 31 30]
	in04 = _mm256_lddqu_si256((const __m256i*)&blk[4 * 16]);   // [47 46 45 44 43 42 41 40]
	in05 = _mm256_lddqu_si256((const __m256i*)&blk[5 * 16]);     // [57 56 55 54 53 52 51 50]
	in06 = _mm256_lddqu_si256((const __m256i*)&blk[6 * 16]);    // [67 66 65 64 63 62 61 60]
	in07 = _mm256_lddqu_si256((const __m256i*)&blk[7 * 16]);    // [77 76 75 74 73 72 71 70]
	in08 = _mm256_lddqu_si256((const __m256i*)&blk[8 * 16]);
	in09 = _mm256_lddqu_si256((const __m256i*)&blk[9 * 16]);
	in10 = _mm256_lddqu_si256((const __m256i*)&blk[10 * 16]);
	in11 = _mm256_lddqu_si256((const __m256i*)&blk[11 * 16]);
	in12 = _mm256_lddqu_si256((const __m256i*)&blk[12 * 16]);
	in13 = _mm256_lddqu_si256((const __m256i*)&blk[13 * 16]);
	in14 = _mm256_lddqu_si256((const __m256i*)&blk[14 * 16]);
	in15 = _mm256_lddqu_si256((const __m256i*)&blk[15 * 16]);
...
#undef TRANSPOSE_16x16_16BIT
	...
	_mm256_storeu_si256((__m256i*)&blk[0 * 16 + 0], in00);
	_mm256_storeu_si256((__m256i*)&blk[1 * 16 + 0], in01);
	_mm256_storeu_si256((__m256i*)&blk[2 * 16 + 0], in02);
	_mm256_storeu_si256((__m256i*)&blk[3 * 16 + 0], in03);
	_mm256_storeu_si256((__m256i*)&blk[4 * 16 + 0], in04);
	_mm256_storeu_si256((__m256i*)&blk[5 * 16 + 0], in05);
	_mm256_storeu_si256((__m256i*)&blk[6 * 16 + 0], in06);
	_mm256_storeu_si256((__m256i*)&blk[7 * 16 + 0], in07);
	_mm256_storeu_si256((__m256i*)&blk[8 * 16 + 0], in08);
	_mm256_storeu_si256((__m256i*)&blk[9 * 16 + 0], in09);
	_mm256_storeu_si256((__m256i*)&blk[10 * 16 + 0], in10);
	_mm256_storeu_si256((__m256i*)&blk[11 * 16 + 0], in11);
	_mm256_storeu_si256((__m256i*)&blk[12 * 16 + 0], in12);
	_mm256_storeu_si256((__m256i*)&blk[13 * 16 + 0], in13);
	_mm256_storeu_si256((__m256i*)&blk[14 * 16 + 0], in14);
	_mm256_storeu_si256((__m256i*)&blk[15 * 16 + 0], in15);
}
...
void idct_32x32_sse256(coef_t *blk, int shift, int clip)
{
	...
	for ( i = 0; i < 2; i++)
	{
		...
		in00[i] = _mm256_lddqu_si256((const __m256i*)&blk[0 * 32 + offset]);
		in01[i] = _mm256_lddqu_si256((const __m256i*)&blk[1 * 32 + offset]);
		in02[i] = _mm256_lddqu_si256((const __m256i*)&blk[2 * 32 + offset]);
		in03[i] = _mm256_lddqu_si256((const __m256i*)&blk[3 * 32 + offset]);
		in04[i] = _mm256_lddqu_si256((const __m256i*)&blk[4 * 32 + offset]);
		in05[i] = _mm256_lddqu_si256((const __m256i*)&blk[5 * 32 + offset]);
		in06[i] = _mm256_lddqu_si256((const __m256i*)&blk[6 * 32 + offset]);
		in07[i] = _mm256_lddqu_si256((const __m256i*)&blk[7 * 32 + offset]);
		in08[i] = _mm256_lddqu_si256((const __m256i*)&blk[8 * 32 + offset]);
		in09[i] = _mm256_lddqu_si256((const __m256i*)&blk[9 * 32 + offset]);
		in10[i] = _mm256_lddqu_si256((const __m256i*)&blk[10 * 32 + offset]);
		in11[i] = _mm256_lddqu_si256((const __m256i*)&blk[11 * 32 + offset]);
		in12[i] = _mm256_lddqu_si256((const __m256i*)&blk[12 * 32 + offset]);
		in13[i] = _mm256_lddqu_si256((const __m256i*)&blk[13 * 32 + offset]);
		in14[i] = _mm256_lddqu_si256((const __m256i*)&blk[14 * 32 + offset]);
		in15[i] = _mm256_lddqu_si256((const __m256i*)&blk[15 * 32 + offset]);
		in16[i] = _mm256_lddqu_si256((const __m256i*)&blk[16 * 32 + offset]);
		in17[i] = _mm256_lddqu_si256((const __m256i*)&blk[17 * 32 + offset]);
		in18[i] = _mm256_lddqu_si256((const __m256i*)&blk[18 * 32 + offset]);
		in19[i] = _mm256_lddqu_si256((const __m256i*)&blk[19 * 32 + offset]);
		in20[i] = _mm256_lddqu_si256((const __m256i*)&blk[20 * 32 + offset]);
		in21[i] = _mm256_lddqu_si256((const __m256i*)&blk[21 * 32 + offset]);
		in22[i] = _mm256_lddqu_si256((const __m256i*)&blk[22 * 32 + offset]);
		in23[i] = _mm256_lddqu_si256((const __m256i*)&blk[23 * 32 + offset]);
		in24[i] = _mm256_lddqu_si256((const __m256i*)&blk[24 * 32 + offset]);
		in25[i] = _mm256_lddqu_si256((const __m256i*)&blk[25 * 32 + offset]);
		in26[i] = _mm256_lddqu_si256((const __m256i*)&blk[26 * 32 + offset]);
		in27[i] = _mm256_lddqu_si256((const __m256i*)&blk[27 * 32 + offset]);
		in28[i] = _mm256_lddqu_si256((const __m256i*)&blk[28 * 32 + offset]);
		in29[i] = _mm256_lddqu_si256((const __m256i*)&blk[29 * 32 + offset]);
		in30[i] = _mm256_lddqu_si256((const __m256i*)&blk[30 * 32 + offset]);
		in31[i] = _mm256_lddqu_si256((const __m256i*)&blk[31 * 32 + offset]);
	}
...
#undef TRANSPOSE_16x16_16BIT
	...
	{
		const int offset = (i << 4);
		_mm256_storeu_si256((__m256i*)&blk[0 * 32 + offset], in00[i]);
		_mm256_storeu_si256((__m256i*)&blk[1 * 32 + offset], in01[i]);
		_mm256_storeu_si256((__m256i*)&blk[2 * 32 + offset], in02[i]);
		_mm256_storeu_si256((__m256i*)&blk[3 * 32 + offset], in03[i]);
		_mm256_storeu_si256((__m256i*)&blk[4 * 32 + offset], in04[i]);
		_mm256_storeu_si256((__m256i*)&blk[5 * 32 + offset], in05[i]);
		_mm256_storeu_si256((__m256i*)&blk[6 * 32 + offset], in06[i]);
		_mm256_storeu_si256((__m256i*)&blk[7 * 32 + offset], in07[i]);
		_mm256_storeu_si256((__m256i*)&blk[8 * 32 + offset], in08[i]);
		_mm256_storeu_si256((__m256i*)&blk[9 * 32 + offset], in09[i]);
		_mm256_storeu_si256((__m256i*)&blk[10 * 32 + offset], in10[i]);
		_mm256_storeu_si256((__m256i*)&blk[11 * 32 + offset], in11[i]);
		_mm256_storeu_si256((__m256i*)&blk[12 * 32 + offset], in12[i]);
		_mm256_storeu_si256((__m256i*)&blk[13 * 32 + offset], in13[i]);
		_mm256_storeu_si256((__m256i*)&blk[14 * 32 + offset], in14[i]);
		_mm256_storeu_si256((__m256i*)&blk[15 * 32 + offset], in15[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * 32 + offset], in16[i]);
		_mm256_storeu_si256((__m256i*)&blk[17 * 32 + offset], in17[i]);
		_mm256_storeu_si256((__m256i*)&blk[18 * 32 + offset], in18[i]);
		_mm256_storeu_si256((__m256i*)&blk[19 * 32 + offset], in19[i]);
		_mm256_storeu_si256((__m256i*)&blk[20 * 32 + offset], in20[i]);
		_mm256_storeu_si256((__m256i*)&blk[21 * 32 + offset], in21[i]);
		_mm256_storeu_si256((__m256i*)&blk[22 * 32 + offset], in22[i]);
		_mm256_storeu_si256((__m256i*)&blk[23 * 32 + offset], in23[i]);
		_mm256_storeu_si256((__m256i*)&blk[24 * 32 + offset], in24[i]);
		_mm256_storeu_si256((__m256i*)&blk[25 * 32 + offset], in25[i]);
		_mm256_storeu_si256((__m256i*)&blk[26 * 32 + offset], in26[i]);
		_mm256_storeu_si256((__m256i*)&blk[27 * 32 + offset], in27[i]);
		_mm256_storeu_si256((__m256i*)&blk[28 * 32 + offset], in28[i]);
		_mm256_storeu_si256((__m256i*)&blk[29 * 32 + offset], in29[i]);
		_mm256_storeu_si256((__m256i*)&blk[30 * 32 + offset], in30[i]);
		_mm256_storeu_si256((__m256i*)&blk[31 * 32 + offset], in31[i]);
	}
...
void inv_wavelet_NSQT_Hor_sse256(coef_t *blk)
{
	...
	/*--vertical transform--*/
	//32*8, LOAD AND SHIFT
	T00[0] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[0 + 32 * 0]), 1);
	T01[0] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[0 + 32 * 1]), 1);
	T02[0] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[0 + 32 * 2]), 1);
	T03[0] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[0 + 32 * 3]), 1);
	T04[0] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[0 + 32 * 4]), 1);
	T05[0] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[0 + 32 * 5]), 1);
	T06[0] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[0 + 32 * 6]), 1);
	T07[0] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[0 + 32 * 7]), 1);

	T00[1] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 + 32 * 0]), 1);
	T01[1] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 + 32 * 1]), 1);
	T02[1] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 + 32 * 2]), 1);
	T03[1] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 + 32 * 3]), 1);
	T04[1] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 + 32 * 4]), 1);
	T05[1] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 + 32 * 5]), 1);
	T06[1] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 + 32 * 6]), 1);
	T07[1] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 + 32 * 7]), 1);
	...
	//store
	for (i = 0; i < 4; i++){
		_mm256_storeu_si256((__m256i*)&blk[16 * i], T00[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64], T01[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 2], T02[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 3], T03[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 4], T04[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 5], T05[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 6], T06[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 7], T07[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 8], T08[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 9], T09[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 10], T10[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 11], T11[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 12], T12[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 13], T13[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 14], T14[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 15], T15[i]);
	}
}
...
void inv_wavelet_B64_sse256(coef_t *blk)
{
	...
	for (i = 0; i < 2; i++){
		T00[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 0]), 1);
		T01[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 1]), 1);
		T02[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 2]), 1);
		T03[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 3]), 1);
		T04[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 4]), 1);
		T05[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 5]), 1);
		T06[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 6]), 1);
		T07[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 7]), 1);

		T08[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 8]), 1);
		T09[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 9]), 1);
		T10[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 10]), 1);
		T11[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 11]), 1);
		T12[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 12]), 1);
		T13[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 13]), 1);
		T14[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 14]), 1);
		T15[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 15]), 1);

		T16[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 16]), 1);
		T17[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 17]), 1);
		T18[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 18]), 1);
		T19[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 19]), 1);
		T20[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 20]), 1);
		T21[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 21]), 1);
		T22[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 22]), 1);
		T23[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 23]), 1);

		T24[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 24]), 1);
		T25[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 25]), 1);
		T26[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 26]), 1);
		T27[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 27]), 1);
		T28[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 28]), 1);
		T29[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 29]), 1);
		T30[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 30]), 1);
		T31[i] = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[16 * i + 32 * 31]), 1);
	}
	...
	for (i = 0; i < 4; i++){
		...
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 16], T16[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 17], T17[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 18], T18[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 19], T19[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 20], T20[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 21], T21[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 22], T22[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 23], T23[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 24], T24[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 25], T25[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 26], T26[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 27], T27[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 28], T28[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 29], T29[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 30], T30[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 31], T31[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 32], T32[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 33], T33[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 34], T34[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 35], T35[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 36], T36[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 37], T37[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 38], T38[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 39], T39[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 40], T40[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 41], T41[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 42], T42[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 43], T43[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 44], T44[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 45], T45[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 46], T46[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 47], T47[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 48], T48[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 49], T49[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 50], T50[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 51], T51[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 52], T52[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 53], T53[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 54], T54[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 55], T55[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 56], T56[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 57], T57[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 58], T58[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 59], T59[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 60], T60[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 61], T61[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 62], T62[i]);
		_mm256_storeu_si256((__m256i*)&blk[16 * i + 64 * 63], T63[i]);
	}
}
...
void inv_wavelet_NSQT_Ver_sse256(coef_t *blk)
{
	...
	/*--load & shift--*/
	//8*32
	S00 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 0]), 1);
	S01 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 1]), 1);
	S02 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 2]), 1);
	S03 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 3]), 1);
	S04 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 4]), 1);
	S05 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 5]), 1);
	S06 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 6]), 1);
	S07 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 7]), 1);
	S08 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 8]), 1);
	S09 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 9]), 1);
	S10 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 10]), 1);
	S11 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 11]), 1);
	S12 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 12]), 1);
	S13 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 13]), 1);
	S14 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 14]), 1);
	S15 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 15]), 1);
	S16 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 16]), 1);
	S17 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 17]), 1);
	S18 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 18]), 1);
	S19 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 19]), 1);
	S20 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 20]), 1);
	S21 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 21]), 1);
	S22 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 22]), 1);
	S23 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 23]), 1);
	S24 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 24]), 1);
	S25 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 25]), 1);
	S26 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 26]), 1);
	S27 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 27]), 1);
	S28 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 28]), 1);
	S29 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 29]), 1);
	S30 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 30]), 1);
	S31 = _mm256_srai_epi16(_mm256_loadu_si256((__m256i*)&blk[8 * 31]), 1);
	...
	/*--Store--*/
	//16x64
	_mm256_storeu_si256((__m256i*)&blk[16 * 0], V00);
	_mm256_storeu_si256((__m256i*)&blk[16 * 1], V01);
	_mm256_storeu_si256((__m256i*)&blk[16 * 2], V02);
	_mm256_storeu_si256((__m256i*)&blk[16 * 3], V03);
	_mm256_storeu_si256((__m256i*)&blk[16 * 4], V04);
	_mm256_storeu_si256((__m256i*)&blk[16 * 5], V05);
	_mm256_storeu_si256((__m256i*)&blk[16 * 6], V06);
	_mm256_storeu_si256((__m256i*)&blk[16 * 7], V07);
	_mm256_storeu_si256((__m256i*)&blk[16 * 8], V08);
	_mm256_storeu_si256((__m256i*)&blk[16 * 9], V09);
	_mm256_storeu_si256((__m256i*)&blk[16 * 10], V10);
	_mm256_storeu_si256((__m256i*)&blk[16 * 11], V11);
	_mm256_storeu_si256((__m256i*)&blk[16 * 12], V12);
	_mm256_storeu_si256((__m256i*)&blk[16 * 13], V13);
	_mm256_storeu_si256((__m256i*)&blk[16 * 14], V14);
	_mm256_storeu_si256((__m256i*)&blk[16 * 15], V15);
	_mm256_storeu_si256((__m256i*)&blk[16 * 16], V16);
	_mm256_storeu_si256((__m256i*)&blk[16 * 17], V17);
	_mm256_storeu_si256((__m256i*)&blk[16 * 18], V18);
	_mm256_storeu_si256((__m256i*)&blk[16 * 19], V19);
	_mm256_storeu_si256((__m256i*)&blk[16 * 20], V20);
	_mm256_storeu_si256((__m256i*)&blk[16 * 21], V21);
	_mm256_storeu_si256((__m256i*)&blk[16 * 22], V22);
	_mm256_storeu_si256((__m256i*)&blk[16 * 23], V23);
	_mm256_storeu_si256((__m256i*)&blk[16 * 24], V24);
	_mm256_storeu_si256((__m256i*)&blk[16 * 25], V25);
	_mm256_storeu_si256((__m256i*)&blk[16 * 26], V26);
	_mm256_storeu_si256((__m256i*)&blk[16 * 27], V27);
	_mm256_storeu_si256((__m256i*)&blk[16 * 28], V28);
	_mm256_storeu_si256((__m256i*)&blk[16 * 29], V29);
	_mm256_storeu_si256((__m256i*)&blk[16 * 30], V30);
	_mm256_storeu_si256((__m256i*)&blk[16 * 31], V31);
	_mm256_storeu_si256((__m256i*)&blk[16 * 32], V32);
	_mm256_storeu_si256((__m256i*)&blk[16 * 33], V33);
	_mm256_storeu_si256((__m256i*)&blk[16 * 34], V34);
	_mm256_storeu_si256((__m256i*)&blk[16 * 35], V35);
	_mm256_storeu_si256((__m256i*)&blk[16 * 36], V36);
	_mm256_storeu_si256((__m256i*)&blk[16 * 37], V37);
	_mm256_storeu_si256((__m256i*)&blk[16 * 38], V38);
	_mm256_storeu_si256((__m256i*)&blk[16 * 39], V39);
	_mm256_storeu_si256((__m256i*)&blk[16 * 40], V40);
	_mm256_storeu_si256((__m256i*)&blk[16 * 41], V41);
	_mm256_storeu_si256((__m256i*)&blk[16 * 42], V42);
	_mm256_storeu_si256((__m256i*)&blk[16 * 43], V43);
	_mm256_storeu_si256((__m256i*)&blk[16 * 44], V44);
	_mm256_storeu_si256((__m256i*)&blk[16 * 45], V45);
	_mm256_storeu_si256((__m256i*)&blk[16 * 46], V46);
	_mm256_storeu_si256((__m256i*)&blk[16 * 47], V47);
	_mm256_storeu_si256((__m256i*)&blk[16 * 48], V48);
	_mm256_storeu_si256((__m256i*)&blk[16 * 49], V49);
	_mm256_storeu_si256((__m256i*)&blk[16 * 50], V50);
	_mm256_storeu_si256((__m256i*)&blk[16 * 51], V51);
	_mm256_storeu_si256((__m256i*)&blk[16 * 52], V52);
	_mm256_storeu_si256((__m256i*)&blk[16 * 53], V53);
	_mm256_storeu_si256((__m256i*)&blk[16 * 54], V54);
	_mm256_storeu_si256((__m256i*)&blk[16 * 55], V55);
	_mm256_storeu_si256((__m256i*)&blk[16 * 56], V56);
	_mm256_storeu_si256((__m256i*)&blk[16 * 57], V57);
	_mm256_storeu_si256((__m256i*)&blk[16 * 58], V58);
	_mm256_storeu_si256((__m256i*)&blk[16 * 59], V59);
	_mm256_storeu_si256((__m256i*)&blk[16 * 60], V60);
	_mm256_storeu_si256((__m256i*)&blk[16 * 61], V61);
	_mm256_storeu_si256((__m256i*)&blk[16 * 62], V62);
	_mm256_storeu_si256((__m256i*)&blk[16 * 63], V63);
}